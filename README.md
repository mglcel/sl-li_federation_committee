...
- [Une Fédération, oui...mais pourquoi ?](#why)
- [Une Fédération, oui...mais c'est quoi ?](#what)
- [Comment créer sa Fédération](#how)
- [Y'a-t-il un pilote dans la Fédération ?](#pilot)
- [Comment un cartel expert peut vendre sa came ?](#cartel)
	- [La Fédération n'est jamais seule](#neveralone)
- [Les fiches mémoire](#memory)
	- [La fédération en un tableau](#fedearra)
...
## Une Fédération, oui...mais pourquoi ?<a name="why"></a>
...
## Une Fédération, oui...mais c'est quoi ?<a name="what"></a>
...
## Comment créer sa Fédération<a name="how"></a>

![Créer sa fédération](img/create.png)

### Formaliser

![Formaliser](img/formalize.png)

## Y'a-t-il un pilote dans la Fédération ? <a name="pilot"></a>
...
Capitaine ne veut pas dire qu'on a plus de poids dans les décisions prise par la Fédération, il sera là pour s'assurer que toutes les informations sont bien portées à la connaissance des membres de l'équipe, **il organise et oriente les travaux de la fédération**, il prendra garde d'**éclairer** les débats avec tout son savoir, car oui, le capitaine se doit de connaître le sujet qu'il traite et avoir une appétence sur le domaine de la Fédération.
...
Il est l'interlocuteur privilégié du Comité, et vous pouvez lire la suite [ici](#neveralone) sur ce sujet. 

**Le Capitaine est un Team Leader**.


## Comment un cartel expert peut vendre sa came ? <a name="cartel"></a>
...
**La Fédération n'est jamais seule** <a name="neveralone"></a>
...
## Les fiches mémoire <a name="memory"></a>

### La Fédération en un tableau <a name="fedearray"></a>
...
### Glossaire <a name="glossary"></a>

> *"Mal nommer les choses, c\'est ajouter aux malheurs du monde"*
> **La Fouine, 30 février 1943**


**Comité** <a name="comitee"></a>
...
**Observateur** <a name="observer"></a>

<p style='text-align: justify;'>
L'observateur est une personne souhaitant participer aux sessions de la Fédération, il peut donner son avis, remonter des informations, mais n'a pas de droit de vote au sein de la Fédération. Sa venue dans les sessions est soumise à la validation de la Fédération (« *T'as des baskets ? Tu rentres pas !* » Christophe Castaner). Ce rôle n'est soumis à aucune obligation de présence. Pas de limite d'observateurs dans une Fédération, mais une présence limitée à 3 obs dans une session de la Fédération.]
</p>